                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <Input
                                ...
                                value={
                                    config.kickRedirectUri ||
                                    "http://localhost:8889/callback"
                                }
                                onChange={(e) =>
                                    onInput("kickRedirectUri", e.target.value)
                                }
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div>
                                <Toggle
                                    checked={
                                        config.saveCurrentSongToFile ?? false
                                    }
                                    onChange={(checked) =>
                                        onInput(
                                ...
                                <p className="text-sm text-zinc-400 mt-1">
                                    Save the currently playing song to a text
                                    file
                                </p>
                            </div>
                                ...
                                <div className="space-y-4 pl-4 border-l-2 border-zinc-700">
                                    <div>
                                        <Input
                                            ...
                                            error={
                                                !!validationErrors.currentSongFilePath
                                            }
                                            helperText={
                                                validationErrors.currentSongFilePath ||
                                                "Path where the current song will be saved"
                                            }
                                        />
                                        <button
                                            onClick={async () => {
                                                const path =
                                                    await window.electronAPI.selectSongFilePath();
                                                if (path) {
                                                    onInput(
                                                        "currentSongFilePath",
                                                        path
