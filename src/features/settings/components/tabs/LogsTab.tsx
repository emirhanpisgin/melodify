...
export default function LogsTab({ logs }: LogsTabProps) {
    ...
    return (
        <div className="flex flex-col h-full w-full min-w-0">
            <div className="flex-1 overflow-y-auto bg-zinc-900 border border-zinc-800 rounded p-2 text-xs font-mono text-left break-words whitespace-pre-wrap min-w-0" style={{ minHeight: 300, maxHeight: 400 }}>
                ...
                {logs.map((log, i) => {
                    ...
                    if (!log || typeof log.level !== "string" || typeof log.message !== "string") {
                        return (
                            <div key={i} className="text-zinc-500 break-words whitespace-pre-wrap min-w-0">
