...
export default function UpdateTab() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-lg font-semibold text-white mb-4">Application Updates</h2>
                <div className="bg-gray-800 p-4 rounded-lg space-y-4">
                    <div className="flex justify-between items-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400">{status === 'available' ? manifest?.version : 'N/A'}</p>
                        </div>
                    </div>

                    {status === 'downloading' && (
                        <div>
                            <p className="text-white mb-1">Downloading update...</p>
