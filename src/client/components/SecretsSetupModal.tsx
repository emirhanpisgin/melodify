            ...
            <div className="relative bg-black w-full h-full p-2 px-4">
                ...
                <div>
                    <div className="text-sm text-gray-400 mt-4">
                        - Go to <a href={dashboardUrl} target="_blank" rel="noopener noreferrer" className={service === "Kick" ? "text-kick-green hover:text-kick-green-dark group" : "text-spotify-green hover:text-spotify-green-dark group"}>{service} Developer Dashboard</a> and create an app.<br />
                    ...
                    <div className="mt-4 flex gap-3">
                        ...
                        {hasSecrets ? (
                            ...
                            <span className="text-blue-400 flex items-center gap-1 text-xs">You can change these values later in the app settings.</span>
                        )}
                    </div>
                </div>
            </div>
