...
export default function SpotifyIcon({ className, ...props }: SpotifyIconProps) {
    return (
        <svg className={cn("", className)} {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
            <path fill="#ffffff" d="M248 8C111.1 8 0 119.1 0 256s111.1 248 248 248 248-111.1 248-248S384.9 8 248 8Z" />
